...
class FingerTrap(Strategy):
    ...
    async def check_trend(self):
        ...
        fast: list[FTCandle] = [candle for candle in fast[1:self.trend]]
        slow: list[FTCandle] = [candle for candle in slow[1:self.trend]]
    ...
    async def trade(self):
        while True:
            try:
                ...
                await self.trader.place_trade(order=entry.type)
                await self.sleep(entry.time)
